...
TEST_ITEMS = "T4_BAG,T5_BAG,T6_BAG,T4_CAPE,T5_CAPE,T6_CAPE,T4_MAIN_SPEAR,T5_MAIN_SPEAR,T6_MAIN_SPEAR,T4_MAIN_SWORD,T5_MAIN_SWORD,T6_MAIN_SWORD,T4_MAIN_AXE,T5_MAIN_AXE,T6_MAIN_AXE,T4_MAIN_BOW,T5_MAIN_BOW,T6_MAIN_BOW,T4_MAIN_FIRESTAFF,T5_MAIN_FIRESTAFF,T6_MAIN_FIRESTAFF"
