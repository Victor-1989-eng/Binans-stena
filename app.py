...
INITIAL_WALL_THRESHOLD_USD = 1400_000  # Детект стены от $1.5M
...
MAX_BEHIND_WALL_VOL_USD = 100_000       # Макс. объем на любом из уровней за стеной

# 4. Риск-менеджмент
TAKE_PROFIT_USD = 0.60                  # Тейк-профит (+$0.50 от входа)
STOP_LOSS_OFFSET = 0.30                 # Фиксированный стоп-лосс ($0.25)
